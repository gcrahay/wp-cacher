<?php
/**
 * This file is imported from the Wordpress appcachify plugin by Robert O'Rourke.
 *
 * @link https://wordpress.org/plugins/appcachify/
 * @link http://interconnectit.com
 *
 * License: GPLv3
 * License URI: http://www.gnu.org/licenses/gpl-3.0.html
 *
 * Copyright (c) 2014 by Robert O'Rourke
 * Copyright (c) 2016 by Gaetan Crahay
 */
if ( ! class_exists( 'appcachify' ) ) {
        ...
        class appcachify {
                ...
                */
                ...
                public function get_cached_by_category() {
                      ...
                      $args = array(
                        ...
                        'post_status'      => 'publish',
                        'suppress_filters' => true,
                        'category__in'     => $cached_categories,
                        'meta_query' => array(
                		'relation' => 'OR',
		                array(
			            'key'     => '_wpc_cached',
                ...
                public function manifest() {
                        ...
                        $update = implode( "\n# ", array_filter( array(
                                ...
                                'modified' => 'Modified: ' . get_option( '_wpc_manifest_timestamp'),//$assets_updated ),
